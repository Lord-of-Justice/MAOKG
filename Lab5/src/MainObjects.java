...
public class MainObjects extends JFrame {
    ...
    public MainObjects() throws IOException {
        ...
        ball = getBallGroup("box04", "src/source_folder/volleyball.obj");
        root.addChild(ball);
        stairs = getStairsGroup("layer0_001", "src/source_folder/3d-model.obj");
    ...
    private void addImageBackground() {
        TextureLoader t = new TextureLoader("src/source_folder/flat.jpg", canvas);
